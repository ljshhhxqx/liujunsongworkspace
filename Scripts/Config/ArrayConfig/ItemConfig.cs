...
namespace HotUpdate.Scripts.Config.ArrayConfig
{
    ...
    public struct GameItemConfigData : IEquatable<GameItemConfigData>
    {
        ...
        {
            return id == other.id && name == other.name && desc == other.desc && price.Equals(other.price) && 
                   sellPriceRatio.Equals(other.sellPriceRatio) && itemType == other.itemType && maxStack == other.maxStack && 
                   weight == other.weight && iconName == other.iconName && prefabName == other.prefabName &&
                   duration.Equals(other.duration) && quality == other.quality && equipmentPart == other.equipmentPart && 
                   buffExtraData == null && propertyDesc == other.propertyDesc;
        }
