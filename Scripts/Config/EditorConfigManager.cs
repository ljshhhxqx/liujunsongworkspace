...
namespace HotUpdate.Scripts.Config
{
    ...
    public class EditorConfigManager : ScriptableObject, IConfigProvider
    {
        [SerializeField] 
        ...
        private static EditorConfigManager instance;
        public static EditorConfigManager Instance
        {
            get
            {
                instance ??= AssetDatabase.LoadAssetAtPath<EditorConfigManager>("Assets/Editor/Config/ConfigManager.asset");
                return instance;
            }
        }
