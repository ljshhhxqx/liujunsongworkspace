...
using PropertySkillCommand = AOTScripts.Data.PropertySkillCommand;
...
namespace HotUpdate.Scripts.Network.PredictSystem.SyncSystem
{
    public class PlayerPropertySyncSystem : BaseSyncSystem
    {
        ...
        [ClientRpc]
        private void RpcSetPlayerPropertyState(int connectionId, uint netId, byte[] playerPropertyState)
        {
        ...
        public override ISyncPropertyState ProcessCommand(INetworkCommand command)
        {
            ...
            else if (command is PropertyAttackCommand attackCommand)
            {
                ...
                {
                    Debug.Log($"PlayerPropertySyncSystem: {header.ConnectionId} attack {targetPlayerIds[i]}");
                }
            }
        ...
        {
            if (_propertyPredictionStates.TryGetValue(connectionId, out var playerPredictableState))
            {
