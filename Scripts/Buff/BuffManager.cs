...
{
    public class BuffManager : NetworkMonoComponent
    {
        ...
        public void AddBuff(PlayerPropertyComponent targetStats, BuffType buffType)
        {
            ...
            {
                var newBuff = new global::Buff(buffData.Value.buffType, buffData.Value.propertyTypeEnum, buffData.Value.duration, buffData.Value.effectStrength, targetStats.PlayerId);
